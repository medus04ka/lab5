...
public class AddCommand extends AbstractCommand {
    ...
    public AddCommand(String name, String description, ModificationReceiver modificationReceiver, HumanBeingReader humanBeingReader, BufferedDataWriter infoWriter) {
    ...
    public void execute(String[] args) {
        ...
        modificationReceiver.add(humanBeing);
        infoWriter.writeInfo("Элемент успешно добавлен");
    }
}
